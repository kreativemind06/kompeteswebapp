            ...
            "content" style="background-color: #FFFFFF">
                <tr>
                    <td id="templateContainerHeader" valign="top" mc:edit="welcomeEdit-01">
                        <p style="text-align:center;margin:0;padding:0;"><img src="'.$logo.'" width="35" style="display:inline-block;"> <b style="font-size: 26px;">Kompetes</b></p>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                                    ...
                                    <h1><strong>Congratulations on signing up<br>
                                            for Kompetes!</strong></h1>

                                    <h3>Thanks for joining our platform. here you can kompete with your best pictures online, inspire others and browse photo contests </h3>
                                </td>
                            </tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                ...
                                                <h4>Activate your Kompetes account by clicking on the below email confirmation link or copy the link to your url bar if clicking is not permitted
                                                    <br> <a class="btn blue-btn" href=" '. base_url().'authentication/confirmmail/'.$uniqueID.'">Click here to confirm</a>
                                                    <br>
                                                    or copy the link
                                                    <div class="">
                                                        '.  base_url().'authentication/confirmmail/'.$uniqueID.'
                                                    </div>
                                                </h4>
                                            </td>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                <h3><strong>Publish your first Photo(s)</strong></h3>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td valign="top" mc:edit="welcomeEditTxtFirst">
                                                ...
                                                <h4>Our community is only as good as its members. Share Kompetes with your friends.</h4>
                                            </td>
