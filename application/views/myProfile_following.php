                        ...
                        <a href="<?php echo base_url("profile/check/".$followerID)?>">
                            ...
                            <div class="grid-user-content" style="background: #f2f2f2">
                                <div class="grid-user-picture">
                                    <img src="<?php if(!empty($followerPhoto->picture)){echo base_url('users_photo/'.$followerPhoto->picture);}else{echo base_url('users_photo/avatar.png');} ?>" class="img-circle img-thumbnail" style="height: 50px; width: 50px;" width="100">
                                </div>
                                ...
                                <div class="text-center">
                                    <div class="body-right">
                                        ...
                                        <?php }else{ ?>
                                            ...
                                            <span class="buttons" id="button_<?php echo $followerID.'-'. $followersName.'-'.$_SESSION['userLogginID'].'-'.$username ?>">
                                                    <a class="btn follow following" href="javascript: void(0)" id="<?php echo $followerID ?>" rel="<?php echo $followerID ?>" rel="<?php echo $followerID ?>">
                                                        <i class="fa fa-user-plus text-red"></i>
                                                        Unfollowing
                                                    </a>
                                                </span>
