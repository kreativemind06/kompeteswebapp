        ...
        <div class="col-sm-10 col-sm-offset-1 no-margin-xs no-padding-xs">
            ...
            <div class="row text-center" style="min-height: 50px; margin-top: -32px;margin-bottom: 70px">
                <ul class="nav nav-tabs" style="width:;">
                    <li class="no-border-radius text-black f-s-20" style="width: 50%"><a href="<?php echo base_url('upload')?>" class="text-black"> Upload Photos </a> </li>
                    <li style="width:50%;border-bottom: 2px solid #f00;"><a href="<?php echo base_url('upload/video')?>" class="text-black f-s-20">Upload Videos </a> </li>
                </ul>
            </div>
