        ...
        <div class="col-sm-8 col-sm-offset-2 no-margin-xs no-padding-xs">
            ...
            <div class="m-t-40" style="background: #fff;min-height: 300px">
                ...
                <p class="text-center f-w-400">
                    You will be redirected to admin dashboard page in <span id='secondsDisplay' style='color:#f00'>15 Seconds</span>; Click <a href="<?php echo base_url('admin/home')?>"> here </a> if nothing happens
                </p>
